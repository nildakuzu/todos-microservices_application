...
namespace EventBus.Base.Abstraction
{
    public interface IEventBusSubscriptionManager
    {
        ...
        IEnumerable<SubscriptionHandlerType> GetHandlersForEvent<T>() where T : IntegrationEvent;

        IEnumerable<SubscriptionHandlerType> GetHandlersForEvent(string eventName);
